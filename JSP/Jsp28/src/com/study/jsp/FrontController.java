...
import com.study.jsp.command.ClientCommand;
import com.study.jsp.command.DownloadCommand;
import com.study.jsp.command.RListCommand;
import com.study.jsp.command.RPwCheckCommand;
...
public class FrontController extends HttpServlet {
			...
			throws ServletException, IOException
	{
		...
		if(com.equals("/loginOk.do")) {
			...
			// 방 채팅
		} else if(com.equals("/client.do")) {
			command = new ClientCommand();
			command.execute(request, response);
			viewPage = "client.jsp";
		} else if(com.equals("/PwCheck.do")) {
			command = new RPwCheckCommand();
			command.execute(request, response);
